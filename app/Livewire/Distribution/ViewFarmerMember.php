...
class ViewFarmerMember extends Component implements HasActions, HasSchemas, HasTable
{
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->query(fn (): Builder => FarmerDistributionRecord::query()
    ...
    {
        return view('livewire.distribution.view-farmer-member');
    }
}
