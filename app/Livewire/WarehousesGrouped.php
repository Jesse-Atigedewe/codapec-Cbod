...
class WarehousesGrouped extends Component
{
    ...
    public function render()
    {
        $query = WarehouseStock::query()
            ->selectRaw("warehouses.id as warehouse_id, warehouses.name as warehouse_name, chemicals.id as chemical_id, chemicals.name as chemical_name, chemicals.name as chemical_name, COALESCE(chemical_types.name, 'Uncategorized') as chemical_type, COALESCE(SUM(warehouse_stocks.quantity_available), 0) as remaining")
