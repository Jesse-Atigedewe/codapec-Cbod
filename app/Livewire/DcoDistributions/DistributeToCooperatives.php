...
class DistributeToCooperatives extends Component implements HasActions, HasSchemas
{
        ...
        return $schema
            ->components([
                ...
                Select::make('cooperative_id')
                    ->label('Cooperative')
                    ->options(fn () => Cooperative::pluck('name', 'id')->toArray())
                    ->searchable()
                    ->preload()
                    ->required(),
            ...
            ->statePath('data')
            ->model(CooperativeDistributionRecord::class);
    }
    ...
    public function create(): void
    {
        ...
        Notification::make()
            ->success()
            ->title('Distributed to cooperative successfully.')
            ->send();
    ...
    {
        return view('livewire.dco-distributions.distribute-to-cooperatives');
    }
}
